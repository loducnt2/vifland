...
const nhapInputImg = () => {
    ...
    //         '.dangbaiviet input[type="file"]'
    //     );
    //     const plugin = FilePond.registerPlugin(FilePondPluginImagePreview);
    //     const pond = FilePond.create(inputElement);
    //     FilePond.setOptions({
    //         imagePreviewHeight: 200,
    //         labelIdle:
    //             'Thêm ảnh hiển thị <span class="filepond--label-action"> tại đây </span>'
    //     });
