                        ...
                        <div class="row">
                            <div class="col-md-12 col-lg-3">
                                <div class="box-left-admin">
                                    ...
                                    <a href="{{route('logout')}}"><p>Thoát tài khoản </p></a>
                                    </div>
                                </div>
                            </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-4 form-group">
                                                                    <select class="input-select" name="">
                                                                        <option hidden="" disabled="" selected="" value="">Tháng</option>
                                                ...
                                                <form action="">
                                                    <div class="row form-wrap thongtinform">
                                                        ...
                                                        <div class="col-md-12 col-lg-4 form-group">
                                                            ...
                                                            <p class="notemk">Vì lý do an ninh, bạn phải xác minh mật khẩu hiện tại trước khi đặt mật khẩu mới.</p>
                                                        </div>
                                                    </div>
                                                    <div class="row form-wrap thongtinform">
                                                        <div class="col-md-12 col-lg-3 form-group">
