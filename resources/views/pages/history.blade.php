...
<main>
    ...
    <section class="pages-favourites">
        <div class="max-width-container">
            @if(count($products)==0)
            <div class="article-none"> <img class="lazyload" data-src="./assets/san_pham/no-documents.png" alt="">
                            ...
                            <div class="box-sp-text"> <a href="{{route('article-detail',$product->slug)}}">
                                ...
                                <div class="info">
                                    <div class="content">
                                        ...
                                        <p data-toggle="tooltip" data-placement="bottom"
                                            title="{{ $product->price == 0 | $product->price == NULL ?'':round($product->price,2)}} {{$product->unit != NULL?$product->unit:'Thương lượng'}}">
                                            {{ $product->price == 0 | $product->price == NULL ?'':round($product->price,2)}}
                                            {{$product->unit != NULL?$product->unit:'Thương lượng'}} </p>
                                    </div>
                                    <div class="content">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="dashed-line"></div>
                                        <p data-toggle="tooltip" data-placement="bottom"
                                            title="Mặt tiền: {{$product->facades != NULL ? round($product->facades,2) : ''}} m">
                                            {{$product->facades != NULL ? round($product->facades,2) : ''}} m </p>
                                    </div>
                                    <div class="content">
                                        ...
                                        <div class="dashed-line"></div>
                                        <p data-toggle="tooltip" data-placement="bottom"
                                            title="Mặt tiền: {{$product->depth !=NULL ? round($product->depth,2) : ''}} m">
                                            {{$product->depth !=NULL ? round($product->depth,2) : ''}} m </p>
                                    </div>
                                    <!-- <div class="content">
