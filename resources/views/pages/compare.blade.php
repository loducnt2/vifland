...
<main>
    ...
    <section class="pages-compare">
        <div class="max-width-container">
                                    ...
                                    <div class="box-sp">
                                        ...
                                        <div class="box-sp-text"> <a href="{{route('article-detail',$product->slug)}}">
                                            ...
                                            <div class="info">
                                                <div class="cover">
                                                    <p data-toggle="tooltip" data-placement="bottom"
                                                        title="Loại hình: Đất dự án">{{$product->product_cate}} </p>
                                                    <div class="dashed-line"></div>
                                                </div>
                                                <div class="cover">
                                                    <p data-toggle="tooltip" data-placement="bottom"
                                                        title="Mặt tiền: {{round($product->facades,2)}} m">
                                                ...
                                                <div class="cover">
                                                    <p data-toggle="tooltip" data-placement="bottom"
                                                        title="Diện Tích: {{round(doubleval( $product->depth*$product->facades ),2 ) }} m²">
                                                        {{round(doubleval( $product->depth*$product->facades ),2 ) }} m²
                                                    </p>
                                                    <div class="dashed-line"></div>
                                                </div>
                                                <div class="cover">
                                                    <p data-toggle="tooltip" data-placement="bottom"
                                                        title="Đơn Giá: {{ $product->price == 0 | $product->price == NULL ?'':round($product->price,2)}} {{$product->unit != NULL?$product->unit:'Thương lượng'}}">
            ...
            @else
            <div class="article-none" id="article-none"> <img src="{{asset('assets/san_pham/no-documents.png')}}"
                    alt="">
