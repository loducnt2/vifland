                                    ...
                                    <div class="box-sp">
                                        ...
                                        <div class="box-sp-text"> <a href="{{route('article-detail',$product->slug)}}">
                                            ...
                                            <div class="info">
                                                ...
                                                <div class="cover">
                                                    <p data-toggle="tooltip" data-placement="bottom"
                                                        title="Mặt tiền: {{$product->facades}} m">{{$product->facades}}
                                                        m</p>
                                                    <div class="dashed-line"></div>
                                                </div>
                                                <div class="cover">
                                                    <p data-toggle="tooltip" data-placement="bottom"
                                                        title="Chiều sâu: {{$product->depth}} m">{{$product->depth}} m
                                                    </p>
                                                    <div class="dashed-line"></div>
                                                </div>
                                                <div class="cover">
                                                    <p data-toggle="tooltip" data-placement="bottom"
                                                        title="Diện Tích: {{doubleval( $product->depth*$product->facades )}} m²">
                                                        {{doubleval( $product->depth*$product->facades )}} m²</p>
                                                    <div class="dashed-line"></div>
                                                </div>
                                                <div class="cover">
                                                    <p data-toggle="tooltip" data-placement="bottom"
                                                        title="Đơn Giá: {{$product->price}} {{$product->unit}}">
