                        ...
                        <tr>
                                    ...
                                    <div class="box-sp-text"> <a href="{{route('article-detail',$product->slug)}}">
                                        ...
                                        <div class="location"> <span class="material-icons">location_on</span>
                                            <p class="lcl lcl-1" data-toggle="tooltip" data-placement="bottom"
                                                title="Quận cầu giấy, Thành Phố Hà Nội">{{$product->district}}, {{$product->province}}
                                            </p>
                                        </div>
                                        <div class="end-mota">
                            ...
                            <td>
                                <p data-toggle="tooltip" data-placement="bottom"
                                    title='Tổng gia: {{$product->price == 0?"":round($product->price,2)}} {{$product->unit}}'>{{$product->price == 0?"":round($product->price,2)}} {{$product->unit}}</p>
                            </td>
                            <td>
                                <p data-toggle="tooltip" data-placement="bottom"
                            ...
                            <td>
                                <p data-toggle="tooltip" data-placement="bottom"
                                    title="Mặt tiền: {round($product->facades,2)}} m">{round($product->facades,2)}} m </p>
                            </td>
                            <td>
