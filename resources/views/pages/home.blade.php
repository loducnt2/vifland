                                    ...
                                    <div class="mota-place-1">
                                            ...
                                            <div class="max-width-container">
                                                <div class="row pd-banner">
                                                    <div class="col-xs-4 col-md-4 col-lg-3">
                                                        <div class="box-left-banner">
                                                            <h2 class="title-banner">Hệ sinh thái <br>Bất động sản</h2>
                                                            <p class="text-banner">Cuộc cách mạng vĩ đại trong kỷ nguyên
                                                                4.0 với sự kết hợp hoàn hảo giữa: con người + trí thông
                                                                minh nhân tạo + bất động sản + đầu tư tài chính</p>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-8 col-md-8 col-lg-9">
                                                        <div class="slide-banner">
                                                                ...
                                                                <div class="swiper-wrapper">
                                                                    <div class="swiper-slide">
                                                                        <div class="img-banner"><img
                                                                                src="{{asset('assets/bg/banner1.png')}}"
                                                                                alt=""></div>
                                                                    </div>
                                                                    <div class="swiper-slide">
                                                                        <div class="img-banner"><img
                                                                                src="{{asset('assets/bg/banner2.png')}}"
                                                                                alt=""></div>
                                                                    </div>
                                                                    <div class="swiper-slide">
                                                                        <div class="img-banner"><img
                                                                                src="{{asset('assets/bg/banner3.png')}}"
                                                                                alt=""></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                        ...
                                        <section class="index-s2">
                                            <div class="max-width-container">
                                                <div class="box-menu-mobile">
                                                    <div class="box-mobile-wrap">
                                                        <div class="box-m"><a href=""><img
                                                                    src="./assets/icon/house@3x.png" alt="">
                                                                <p>{{$categories['0']->name}} </p>
                                                            </a></div>
                                                        <div class="box-m"><a href=""><img
                                                                    src="./assets/icon/rent@3x.png" alt="">
                                                                <p>{{$categories['1']->name}}</p>
                                                            </a></div>
                                                        <div class="box-m"><a href=""><img
                                                                    src="./assets/icon/transfer-image-category.png"
                                                                    alt="">
                                                                <p>{{$categories['2']->name}}</p>
                                                            </a></div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-3">
                                                            <div class="box-left">
                                                                <div class="warp-form">
                                                                    <div class="checked">
                                                                        <input id="idgiaohang1" type="radio"
                                                                            value="{{$categories['0']->id}}"
                                                                            name="requirement">
                                                                        <label
                                                                            for="idgiaohang1">{{$categories['0']->name}}</label>
                                                                    </div>
                                                                    <div class="checked">
                                                                        <input id="idgiaohang2" type="radio"
                                                                            value="{{$categories['1']->id}}"
                                                                            name="requirement">
                                                                        <label
                                                                            for="idgiaohang2">{{$categories['1']->name}}</label>
                                                                    </div>
                                                                    <div class="checked">
                                                                        <input id="idgiaohang3" type="radio"
                                                                            value="{{$categories['2']->id}}"
                                                                            name="requirement">
                                                                        <label
                                                                            for="idgiaohang3">{{$categories['2']->name}}</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-9">
                                                            <div class="box-right">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-3">
                                                                        <button class="timkiem-1"> <span>Tìm
                                                                                Kiếm</span></button>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-3">
                                                                        <div class="form-group-sl1 sl-2 select-many">
                                                                            <select class="select1 slnhadat"
                                                                                name="loainhadat[]" multiple="multiple">
                                                                                @foreach($product_cate as $prodcate)
                                                                    ...
                                                                    <div class="col-3">
                                                                        <div class="form-group-sl1 sl-3 select-many">
                                                                            <select class="select1 slgia"
                                                                                name="khoanggia[]" multiple="multiple">
                                                                                @foreach($filter_price as $price)
                                                                    ...
                                                                    <div class="col-3">
                                                                        <div class="form-group-select">
                                                                            <div class="box-left-se"><i
                                                                                    class="ri-filter-line"></i></div>
                                                                            <div class="box-mid-se"><span
                                                                                    class="timnangcao">Tìm Nâng
                                                                                    Cao</span></div>
                                                                            <div class="box-right-se"><i
                                                    ...
                                                    <div class="row">
                                                        <div class="col-4">
                                                            <div class="box-cate">
                                                                <a href="/mua-ban-nha-dat">
                                                                    <div class="img"><img
                                                                            src="{{asset('assets/index/mua-ban-nha-dat.png')}}"
                                                                            alt=""></div>
                                                                    <div class="title-box">{{$categories[0]->name}}
                                                                    </div>
                                                                </a>
                                                                <div class="end-box">
                                                                    <a href="/mua-ban-nha-dat">
                                                                        <div class="box-left"><span
                                                                                class="material-icons">list</span>
                                                                            <p>{{$count_cate1}} Tin đăng</p>
                                                                        </div>
                                                                    </a>
                                                                    <a href="{{route('new',$categories[0]->slug)}}">
                                                                        <div class="box-right"><span
                                                                                class="material-icons">playlist_add</span>
                                                                            <p>Đăng bài</p>
                                                                        </div>
                                                                    </a>
                                                                </div>
                                                        ...
                                                        <div class="col-4">
                                                            <div class="box-cate">
                                                                <a href="/cho-thue-nha-dat">
                                                                    <div class="img"><img
                                                                            src="{{asset('assets/index/cho-thue-nha-dat.png')}}"
                                                                            alt=""></div>
                                                                    <div class="title-box">{{$categories[1]->name}}
                                                                    </div>
                                                                </a>
                                                                <div class="end-box">
                                                                    <a href="/cho-thue-nha-dat">
                                                        ...
                                                        <div class="col-4">
                                                            <div class="box-cate">
                                                                <a href="/sang-nhuong-nha-dat">
                                                                    <div class="img"><img
                                                                            src="{{asset('assets/index/sang-nhuong-nha-dat.png')}}"
                                                                            alt=""></div>
                                                                    <div class="title-box">{{$categories[2]->name}}
                                                                    </div>
                                                                </a>
                                                                <div class="end-box">
                                                                    <a href="/sang-nhuong-nha-dat">
                                        ...
                                        <section class="index-sc4">
                                            <div class="max-width-container">
                                                <div class="text-title">
                                                    <div class="text-left"><a class="text-desktop"
                                                            href="/mua-ban-nha-dat">
                                                            <h3>{{$categories[0]->name}}</h3>
                                                        </a></div>
                                                    <div class="text-right"><a class="text-desktop"
                                                            href="/mua-ban-nha-dat"><i class="ri-equalizer-line"></i>
                                                            <p>Xem tất cả &nbsp;<span>({{count($product_by_cate1)}} Tin
                                                                    đăng)</span></p>
                                                        </a></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="max-width-container">
                                                <div class="swiper-container slideSpHome">
                                                    <div class="swiper-wrapper">
                                                        ...
                                                        <div class="swiper-slide">
                                                            <div class="box-sp">
                                                                <div class="box-sp-img"><a class="localstore"
                                                                        localstore="{{$product->product_id}}"
                                                                        href="{{route('article-detail',$product->slug)}}"><img
                                                                            src="{{asset('assets/product/sanpham1.webp')}}"
                                                                            alt=""></a>
                                                                    <div class="tag-thuongluong">{{$product->price}}
                                                                        {{$product->unit}}</div>
                                                                    <div class="box-icon"><a href="" class="fav"
                                                                            productid="{{$product->product_id}}"><i
                                                                                class="ri-heart-line icons"></i></a><a
                                                                            href="" class="comp"
                                                                            productid="{{$product->product_id}}"><i
                                                                                class="ri-equalizer-line icons"></i></a>
                                                                    </div>
                                                                    <div class="overlay"></div>
                                                                </div>
                                                                <div class="box-sp-text">
                                                                    <a class="localstore"
                                                                        ...
                                                                        <h5 class="title-text lcl lcl-2">
                                                                            {{$product->title}}</h5>
                                                                    </a>
                                                                    <div class="location"> <span
                                                                            class="material-icons">location_on</span>
                                                                        <p class="lcl lcl-1" data-toggle="tooltip"
                                                                    ...
                                                                    <div class="mota-place">
                                                                        <div class="mota-place-1">
                                                                            <div class="mota-place-tt"><img
                                                                                    src="{{asset('assets/icon/dientich.png')}}"
                                                                                    alt=""><span data-toggle="tooltip"
                                                                                    data-placement="bottom"
                                                                                    title="{{intval($product->depth)*intval($product->facades) }} m²">{{intval($product->depth)*intval($product->facades) }}
                                                                                    m²</span></div>
                                                                            <div class="mota-place-tt"><img
                                                                                    src="{{asset('assets/icon/icon-road@3x.png')}}"
                                                                                    alt=""><span data-toggle="tooltip"
                                                                                    data-placement="bottom"
                                                                                    title="Tooltip on bottom">Mặt phố -
                                                                                    mặt đường</span></div>
                                                                            <div class="mota-place-tt"><img
                                                                                    src="{{asset('assets/icon/rectangle-copy-2@3x.png')}}"
                                                                                    alt=""><span data-toggle="tooltip"
                                                                                    data-placement="bottom"
                                                                                    title="{{$product->facades}}">{{$product->facades}}
                                                                                    m</span></div>
                                                                        </div>
                                                                        <!-- <div class="mota-place-1">
...
>>>>>>> 5c37e6449c6199eee9610ab0f5f59c86434c326d
										...
										<div class="mota-place-tt"><span class="material-icons icons-15">group</span><span data-toggle="tooltip" data-placement="bottom" title="Tooltip on bottom">{{$product->depth*$product->facades}} m²</span></div>
                                                            ...
                                                            <div class="article-none"> <img
                                                                    src="{{asset('assets/san_pham/no-documents.png')}}"
                                                                    alt="">
                                                                <p>Không có bài đăng nào</p>
                                                            </div>
                                                            @endif
