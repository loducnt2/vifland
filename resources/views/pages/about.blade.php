		...
		<section class="pages-introduce-sec-1 section"> 
			<div class="container">
				...
				<div class="head-content"> 
					<p>VifLand là một công ty bên thứ 3 chuyên hỗ trợ những nhà đầu tư, doanh nhân và những người có nhu cầu tìm mua những miếng đất liên quan đến bất động sản như nhà, đất đai, chung cư…Qua những bài đăng tin bất động sản trên website cung cấp cho người dùng có thừ vừa mua và bán. Mang đến cho khách hàng một hệ thống cập nhật nhanh các tin tức bất động sản uy tín nhất</p>
				</div>
				<div class="intro-banner"> <img src="./assets/banner/banner-intro.png" alt=""></div>
				<!-- <div class="box-info" >
					<div class="row"> 
				...
				<div class="row"> 
					<div class="col-lg-6 box-content"> 
						...
						<div class="content-item"> 
							...
							<div class="content"> 
								<p>Đặt ra hai nhiệm vụ liên quan đến mục tiêu tài chính để có thể trụ vững trên thị trường. Một là, tập trung ưu tiên quản lý dòng tiền có sẵn phục vụ kinh doanh, đảm bảo duy trì hoạt động ổn định, không mở rộng nhiệm vụ tăng nguồn vốn vì khả năng huy động vốn giai đoạn này là bất khả thi. Hai là, điều chỉnh cơ cấu chi phí sau khi có sự phân tích nguồn vốn, giúp doanh nghiệp có thêm dòng tiền để duy trì hoạt động kinh doanh. Công ty đã thực hiện việc phân công nhân sự làm luân phiên để cắt giảm chi phí, thương lượng với chủ cho thuê mặt bằng để giảm giá, đồng thời tìm kiếm vị trí có giá rẻ hơn, cho thuê lại một phần tòa nhà Công ty và chuyển những cửa hàng thành kho lưu động hàng hóa</p>
							</div>
						</div>
					</div>
					<div class="col-lg-6 box-img"> 
						<div class="img"> <img src="./assets/banner/banner-intro-2.png" alt=""></div>
					</div>
				</div>
			</div>
		</section>
