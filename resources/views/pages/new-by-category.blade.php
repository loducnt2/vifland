            ...
            <div class="row sec-2">
                ...
                <div class="col-xl-4 col-md-4 col-sm-6 wrapper">
                    <div class="article-wrapper">
                        ...
                        <div class="article-small"><a href="/tin-tuc/{{$posts2->slug}}"><img class="lazyload"
                                    data-src="{{asset('assets/news/' .$posts2->img)}}" alt=""></a>
                            <div class="content"><a href="/tin-tuc/{{$posts2->slug}}">
                                    <h2 class="section-under-title">{{$posts2->title}}</h2>
                                </a>
                            </div>
                        </div>
                    </div>
