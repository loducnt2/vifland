                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade" id="thongtin" role="tabpanel"
                                        ...
                                        <div class="form-group-sl1 sl-1 select-many">
                                            ...
                                            <input type="text" min="0" name="price"><em class="notedongia">Mặc định 0 là
                                                thương lượng</em>
                                        </div>
                                    ...
                                    <div class="note-wrap"><em class="note">* Hãy cập nhật các thông số đầy đủ và chi
                                            tiết để khách hàng tìm thấy tin đăng của bạn dễ dàng</em>
                                        <p class="note"> <b>Cảnh báo: &nbsp;</b>Nếu thông tin không được chọn đầy đủ thì
                                ...
                                <div class="wrap-vip-mobile">
                                    <div class="form-group-sl1 sl-1 select-many">
                                        <select class="select1" name="loainhadat">
                                            <option value="tinthuong"> <strong>Tin thường&nbsp;</strong>(Miễn phí)
                                            </option>
                                            <option class="vip1" value="vip1">
                                                <p>TIN VIP 1&nbsp;</p>(15.000 ₫ tin/ngày)
                                            </option>
                                            <option class="vip2" value="vip2"> <span>TIN VIP 2&nbsp;</span>(25.000 ₫
                                                tin/ngày)</option>
                                            <option class="vip3" value="vip3"> <span>TIN VIP 3&nbsp;</span>(35.000 ₫
                                                tin/ngày)</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-12">
                                        ...
                                        <div class="col-6">
                                            <div class="img"> <a href="{{asset('assets/icon/vips1.jpg')}}"
                                                    data-fancybox="images"> <img
                                                        src="{{asset('assets/icon/vips1.jpg')}}" alt=""></a></div>
                                        </div>
                                    </div>
                                </div>
                                <!-- END -->
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <table>
                                                <tr>
                                                    <td class="mb-30">Giá: </td>
                                                    <td class="mb-30"> <strong>40.000 ₫ tin/ngày</strong></td>
                                                </tr>
                                                <tr>
                                                    <td> <span class="material-icons">done</span></td>
                                                    <td> <span>Đứng đầu danh sách các tin đăng</span></td>
                                                </tr>
                                                <tr>
                                                    <td> <span class="material-icons">done</span></td>
                                                    <td> <span>Có tiêu đề <em style="color:#993393">CHỮ IN HOA MÀU
                                                                TÍM</em></span></td>
                                                </tr>
                                                <tr>
                                                    <td> <span class="material-icons">done</span></td>
                                        ...
                                        <div class="col-6">
                                            <div class="img"><a href="{{asset('assets/icon/vips2.jpg')}}"
                                                    data-fancybox="images"> <img
                                                        src="{{asset('assets/icon/vips2.jpg')}}" alt=""></a></div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <table>
                                                <tr>
                                                    <td class="mb-30">Giá: </td>
                                                    <td class="mb-30"> <strong>25.000 ₫ tin/ngày</strong></td>
                                                </tr>
                                                <tr>
                                                    <td> <span class="material-icons">done</span></td>
                                                    <td> <span>Hiển thị dưới tin VIP 1, trên tin VIP 3 và tin
                                                            thường</span></td>
                                                </tr>
                                                <tr>
                                                    <td> <span class="material-icons">done</span></td>
                                                    <td> <span>Có tiêu đề <em style="color: #dd8c43">CHỮ IN HOA MÀU
                                                                CAM</em></span></td>
                                                </tr>
                                                <tr>
                                                    <td> <span class="material-icons">done</span></td>
                                                    <td> <span>Được chèn link video vào trong tin đăng</span></td>
                                                </tr>
                                                <tr>
                                                    <td> <span class="material-icons">done</span></td>
                                        ...
                                        <div class="col-6">
                                            <div class="img"><a href="{{asset('assets/icon/vips3.jpg')}}"
                                                    data-fancybox="images"> <img
                                                        src="{{asset('assets/icon/vips3.jpg')}}" alt=""></a></div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <table>
                                                <tr>
                                                    <td class="mb-30">Giá: </td>
                                                    <td class="mb-30"> <strong>15.000 ₫ tin/ngày</strong></td>
                                                </tr>
                                                <tr>
                                                    <td> <span class="material-icons">done</span></td>
                                                    <td> <span>Hiển thị dưới tin VIP1, VIP2 và trên tin thường</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td> <span class="material-icons">done</span></td>
                                                    <td> <span>Có tiêu đề <em style="color: #b18734">Chữ thường màu vàng
                                                                đồng</em></span></td>
                                                </tr>
                                                <tr>
                                                    <td> <span class="material-icons">done</span></td>
                                        ...
                                        <div class="col-6">
                                            <div class="img"><a href="{{asset('assets/icon/vips4.jpg')}}"
                                                    data-fancybox="images"> <img
                                                        src="{{asset('assets/icon/vips4.jpg')}}" alt=""></a></div>
                                        </div>
                                    </div>
                                </div>
                                <!-- END -->
                                ...
                                <div class="wrap-des-vip" id="sub-vip1">
                                    <div class="wrap-left"><img src="{{asset('assets/icon/vip1.svg')}}" alt="">
                                        <div class="wrap-text">
                                            <p style="color:#993393">Tin VIP 1 - Gói 7 ngày</p><small>Từ ngày
                                                12/10/2020</small>
                                        </div>
                                    </div>
                                ...
                                <div class="wrap-des-vip" id="sub-vip2">
                                    <div class="wrap-left"><img src="{{asset('assets/icon/vip2.svg')}}" alt="">
                                        <div class="wrap-text">
                                            <p style="color:#dd8c43">Tin VIP 2 - Gói 7 ngày</p><small>Từ ngày
                                                12/10/2020</small>
                                        </div>
                                    </div>
                                    <div class="wrap-right">
                                ...
                                <div class="wrap-des-vip" id="sub-vip3">
                                    <div class="wrap-left"><img src="{{asset('assets/icon/vip3.svg')}}" alt="">
                                        <div class="wrap-text">
                                            <p style="color:#b18734">Tin VIP 3 - Gói 7 ngày</p><small>Từ ngày
                                                12/10/2020</small>
                                        </div>
                                    </div>
                                    <div class="wrap-right">
