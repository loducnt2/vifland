                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-sx-12">
                            <div class="box-sp">
                                ...
                                <div class="box-sp-text"> <a href="">
                                        <h5 class="title-text lcl lcl-2">Mở bán shophouse, nhà phố, biệt thự view sông
                                            dự án Aqua City phân khu River Park 1 khu River Park 1</h5>
                                    </a>
                                    ...
                                    <div class="mota-place">
                                        ...
                                        <div class="mota-place-1">
                                            <div class="mota-place-tt"><img src="./assets/icon/rectangle-2@3x.png"
                                                    alt=""><span data-toggle="tooltip" data-placement="bottom"
                                                    title="Tooltip on bottom">Sàn văn phòng, Mặt bằng thương mại, Phòng
                                                    học </span></div>
                                            <div class="mota-place-tt"><img src="./assets/icon/rectangle-3@3x.png"
                                                    alt=""><span data-toggle="tooltip" data-placement="bottom"
                                                    title="Tooltip on bottom">---</span></div>
                                    ...
                                    <div class="end-mota">
                                        <div class="mota-end-box">
                                            <div class="end-box-tt"><span
                                                    ...
                                                    data-toggle="tooltip" data-placement="bottom"
                                                    title="Tooltip on bottom">22/09/2020</span></div>
                                            <div class="end-box-tt"><span
                                                    class="material-icons icons-15">visibility</span><span
                                                    data-toggle="tooltip" data-placement="bottom"
                                                    title="Tooltip on bottom">320</span></div>
                                            <div class="end-box-tt"><span
                                                    class="material-icons icons-15 chat">chat</span><span class="chat"
                                                    data-toggle="tooltip" data-placement="bottom"
                                                    title="Tooltip on bottom">chat ngay</span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
