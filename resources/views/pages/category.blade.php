                                    ...
                                    <div id="content-province">
                                        ...
                                        <p class="MsoNormal"></p><span style="line-height: 107%; font-family: Roboto;">
                                            <font size="3"></font>•<span style="mso-tab-count:1">           </span><b
                                                style="mso-bidi-font-weight:									normal">Động sản</b>: Động sản là
                                            tất
                                        ...
                                        <p class="MsoNormal"></p><span style="line-height: 107%; font-family: Roboto;">
                                            <font size="3"></font>•<span style="mso-tab-count:1">           </span><b
                                                style="mso-bidi-font-weight:									normal">Bất động sản</b>: Bất động
                                            sản
                                        ...
                                        <p class="MsoNormal" style="text-align: center;"></p><span
                                            style="line-height: 107%; font-family: Roboto;"><i></i><span
                                                style="font-size: medium; text-align: start;">Tại Việt Nam khi mà nhà
                                                đất
                                        ...
                                        <p class="MsoNormal" style="text-align: center;"></p><span
                                            style="line-height: 107%; font-family: Roboto;"><i></i><span
                                                style="font-size: medium;">Đầu tư mua bán nhà đất là một bài toán khó
                                                đòi
                                        ...
                                        <p class="MsoNormal"></p><span style="line-height: 107%; font-family: Roboto;">
                                            ...
                                            dàng hơn nhiều với tính năng đăng tin VIP<span
                                                style="mso-spacerun:yes"></span>mọi thông tin của bạn sẽ được hiển thị ở
                                            tại
        ...
        $.ajax({
            ...
            success: function(data, status) {
                ...
                data.forEach(function(item, index, array) {
                    ...
                    switch (item.type) {
                        case 1:
                            title = '<h5 class="title-text lcl lcl-2 vip1">' + item
                                .title + '</h5>'
                            vip = '<div class="vip"><img src="{{asset('
                            assets / icon / vip1.svg ')}}" alt=""></div>'
                            break;
                        case 2:
                            title = '<h5 class="title-text lcl lcl-2 vip2">' + item
                                .title + '</h5>'
                            vip = '<div class="vip"><img src="{{asset('
                            assets / icon / vip2.svg ')}}" alt=""></div>'
                            break;
                        case 3:
                            title = '<h5 class="title-text lcl lcl-2 vip3">' + item
                                .title + '</h5>'
                            break;
                        default:
                            title = '<h5 class="title-text lcl lcl-2 ">' + item
                                .title + '</h5>'
                            vip = '<div class="vip"><img src="{{asset('
                            assets / icon / vip3.svg ')}}" alt=""></div>'
                            break;
                    }
