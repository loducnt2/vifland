...
<body>
    ...
    <form action="/admin/index/quan-ly-thu-tin-tuc/export" method="get">
        <button type="submit" class="btn button-color" style="background-color:#7174E9;color:white">Xuất file
            Excel</button>
    </form>
    <form action="{{ route('table.import') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="mt-4 form-group">
            ...
            <button type="submit" class="mt-4 btn button-color" style="background-color:#7174E9;color:white">Nhập file
                Excel</button>
            <button type="button" class="mt-4 btn button-color " data-toggle="modal" data-target="#modelId">
                Gửi thư quảng cáo
            </button>
        </div>
    </form>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="modal-body">
                                <form action="/send-email" method="POST" enctype="multipart/form-data">
                                    ...
                                    <textarea type="textarea" name="contents" id="contents" class="form-control"
        ...
        <div class="table-responsive">
            <table class="table table-bordered" id="table" width="100%" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                        <!-- Button trigger modal -->
                        <button type="button" class="btn button-color" data-toggle="modal"
                            data-target="#sendEmail{{$newsletter->id}} ">
                            Gửi thư
                        </button>
                    </td>
                    <!-- Modal -->
                    ...
                    <div class="modal fade" id="sendEmail{{$newsletter->id}}" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn button-color text">Gửi thư</button>
...
>>>>>>> 9629920b8801b4292374bff87ff2cb2a20c7d590
                    @endforeach
