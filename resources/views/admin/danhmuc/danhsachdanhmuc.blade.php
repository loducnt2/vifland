...
<body>
    ...
    <div class="container">
            ...
            <tbody id="myTable">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{route('edit-cate',$cate->id)}}"> <button class="btn btn-info">Xem chi tiết</button>
                        </a>
                    </td>
                </tr>
                @endforeach
        ...
        <button type="button" class="btn button-color " data-toggle="modal" data-target="#exampleModal">
            Tạo danh mục mới
        </button>
                    ...
                    <div class="modal-body">
                        <form action="{{route('create-cate')}}" method="POST">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn button-color">Tạo mới</button>
                            </div>
                        </form>
                    </div>
    ...
    <div class="modal fade" id="exampleModal1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            ?>
                        ...
                        <div class="form-group">
                            <label for="exampleInputPassword1">Ngôn ngữ</label>
                            <select class="custom-select" name="lang" value="{{$cate->language}}"
                        ...
                        <div class="form-group">
                            <label for="exampleInputPassword1">Ẩn hiện</label>
                            <select class="custom-select" value="{{$cate->orders}}" name="status"
                                id="inputGroupSelect01">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <a href="{{ route('update-cate',$cate->id) }}"><button type="button" class="btn button-color">Save
                            changes</button></a>
                </div>
            </div>
        </div>
