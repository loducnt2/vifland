                ...
                <div class="col-lg-6">
                    ...
                    <div class="box-n p-5 bcdt">
                        ...
                        <div class="bcdt-chart">
                            <canvas id="bcdt" data-1="50" data-2="50" data-3="50" data-4="50" data-5="50" data-6="50"
                                data-7="50" data-8="50" data-9="50" data-10="50" data-11="50" data-12="50"></canvas>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                            ...
                            <div class="wrap-list-bxh" id="user_rank">
                                ...
                                <div class="list-items-bxh">
                                    <div class="box-n px-4 py-3 item zoom-in">
                                        <div class="left-bxh">
                                            <div class="img">
                                                <img class="lazyload" data-src="{{asset('assets/avatar/user.png')}}"
                                                    alt="">
                                            </div>
                                            <div class="text">
                                                <div class="title">
                                                    {{ $user->full_name == NULL ? $user->username : $user->full_name }}
                                                </div>
