...
<body>
    ...
    var pusher = new Pusher('2b2896f5c6e82939103c', {
        encrypted: true,
        cluster: "ap1"
    });
              ...
              <div class="media">
                <div class="media-left">
                  <div class="media-object">
                    <img data-src="https://api.adorable.io/avatars/71/` + avatar + `.png" class="img-circle lazyload" alt="50x50" style="width: 50px; height: 50px;">
                  </div>
                </div>
