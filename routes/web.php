...
Route::get('/testform', function () {
	return view('pages/article/testform');
});
Auth::routes();
...
Route::get('/compares', 'API\CompareController@index')->name('compare');
...
Route::group(['middleware' => 'auth'], function () {
	...
	// Đăng tin
	Route::get('/article/new/{cate}', 'ProductController@create')->name('new');
	Route::get('/user/my-article/{id}', 'ProductController@getByUser')->name('user-article');
	Route::get('/favourites', 'ProductController@productUserFavorite')->name('favorites');
